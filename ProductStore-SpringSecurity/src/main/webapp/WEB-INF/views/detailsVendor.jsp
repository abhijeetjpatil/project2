...
<div class="container-fluid">
  <div class="row content">
   ...
   <div class="profile-data">
    ...
    <ul class="nav nav-pills nav-stacked">
        ...
        <p style="padding-left: 35px;">Vendor<p>
        <li><a>Office :</a></li>
 ...
 <div class="container-fluid" style="width:500px;">
   <h1><c:out value="${'Vendor Details'}"/></h1> 
 <section>
 </br>
 <nav>
      ...
      ${vendor.name}</span>
       ...
       <span> <b>Location :</b><c:out value="${'  ' }"></c:out> ${vendor.location}</span></h4>
 </nav>      
  </section> 
  <section> 
  <h4 class="contact" ><span><b>Contact :</b></span>
        <span >${vendor.contact}</span></h4>
